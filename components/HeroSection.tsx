...
const HeroSection: React.FC<HeroSectionProps> = ({ locale }) => {
  return (
    <div className="relative z-10 flex overflow-hidden flex-col-reverse md:flex-row items-center justify-between py-20 mx-40 ">
      {/* Left */}
      <div className=" text-center md:text-left overflow-hidden w-1/2">
        {/* text and button */}
        ...
        <p className='text-gray-600 mb-6 leading-relaxed  px-6 md:px-0 w-[512px] '>
